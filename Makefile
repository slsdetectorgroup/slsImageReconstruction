...
$(PROGS_HDF5): 
	@echo $(WD)
# CHOSE OPTIONS  -DZLIB (COMPRESSED ZLIB) -DLZ4 -D(lz4, not fully implemented )  -DSZIP(szip) -DMASTERVIRTUAL (MASTER FILE CONTAINS A VIRTUAL DATASET), -DMASTERLINK (MASETR FILE CONTAINS A LINKED DATASET)
